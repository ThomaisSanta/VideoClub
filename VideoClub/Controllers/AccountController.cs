...
namespace VideoClub.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //_roleManager = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(new VideoClubProjectContext()));
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            else if (user != null && await UserManager.IsInRoleAsync(user.Id, "User"))
            {
                var result = await signInManager.PasswordSignInAsync(user.UserName, model.Password, model.RememberMe, shouldLockout: false);
                switch (result)
                {
                    case SignInStatus.Success:
                        ...
                        return RedirectToAction("IndexUser", "Movie", new { area = "" });
